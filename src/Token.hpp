...
public:
    ...
    static std::string typeToString(tokenType _type) {
        switch (_type) {
            ...
            case tokenType::OF:
                return "OF";
            case tokenType::REAL48_Type:
                return "REAL48_Type";
            case tokenType::REAL_Type:
                return "REAL_Type";
            case tokenType::SINGLE_Type:
                return "SINGLE_Type";
            case tokenType::DOUBLE_Type:
                return "DOUBLE_Type";
            case tokenType::EXTENDED_Type:
                return "EXTENDED_Type";
            case tokenType::CURRENCY_Type:
                return "CURRENCY_Type";
            case tokenType::COMP_Type:
                return "COMP_Type";
            case tokenType::SHORTINT_Type:
                return "SHORTINT_Type";
            case tokenType::SMALLINT_Type:
                return "SMALLINT_Type";
            case tokenType::INTEGER_Type:
                return "INTEGER_Type";
            case tokenType::BYTE_Type:
                return "BYTE_Type";
            case tokenType::LONGINT_Type:
                return "LONGINT_Type";
            case tokenType::INT64_Type:
                return "INT64_Type";
            case tokenType::WORD_Type:
                return "WORD_Type";
            case tokenType::BOOLEAN_Type:
                return "BOOLEAN_Type";
            case tokenType::CHAR_Type:
                return "CHAR_Type";
            case tokenType::WIDECHAR_Type:
                return "WIDECHAR_Type";
            case tokenType::LONGWORD_Type:
                return "LONGWORD_Type";
            case tokenType::PCHAR_Type:
                return "PCHAR_Type";
            case tokenType::VARIANT_Type:
                return "VARIANT_Type";
            case tokenType::OLEVARIANT_Type:
                return "OLEVARIANT_Type";
            case tokenType::ANSISTRING:
                return "ANSISTRING";

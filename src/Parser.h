...
public:
    ...
    void expect(Token::tokenType tokenType) {
        LOG(INFO) << "Parser.expect(" + Token::typeToString(tokenType) + ")\n";
    ...
    Node *Package() {
         ...
         */
        LOG(INFO) << "Package()\n";
        std::cout << "Package() is not implemented and will return nullptr" << std::endl;
        return nullptr;
    ...
    Node *Library() {
         ...
         */
        LOG(INFO) << "Library()\n";
        std::cout << "Library() is not implemented and will return nullptr" << std::endl;
        return nullptr;
    ...
    Node *ImplementationSection() {
         ...
         * ImplementationSection -> IMPLEMENTATION
                                    ...
                                    [DeclSection]...
         */
        LOG(INFO) << "ImplementationSection()\n";
    ...
    Node *TypeDecl() {
        ...
        if (lexer->getCurrentToken()->getType() == Token::tokenType::EQUAL && tmp != nullptr) {
    ...
    Node *Ident(bool bCanFail = false) {
        ...
        if (lexer->getCurrentToken()->getType() == Token::tokenType::Id) {
            ...
            LOG(ERROR) << "Ident() has nothing to return!\n";
            return nullptr;
        }
    }
